...
def ajustl(op, gc, gs, nv, xp, yp, nrc, fcd, il, nb, e , astotal, xb, yb, fyd, perc, na, max, may,epsc2, epscu, a1, a2, const, lx, ly, area, jox, joy, joxy):
    ...
    # Entrada dos dados x, alph e astotal

    x = float(input("Entre com a profundidade do eixo neutro x:"))
    alph = float(input("Entre com o angulo de inclinacao do eixo neutro alpha:"))
    astotal = float(input("Entre com a area de aço astotal:"))
    alph = alph / graus
